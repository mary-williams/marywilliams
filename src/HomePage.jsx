...
const aboutMe1 = "I currently attend the University of Texas at Austin as a Computer Science student. I anticipate to graduate May 2027!";
    ...
    <div className='left-right-row'>
      ...
      <div className= "right-col">
        ...
        <div style={{ marginTop: '2rem' }}>
            <InfoBox size="large" header='Other'>{aboutMe6}</InfoBox>
        </div>
      </div>
    </div>
  )
