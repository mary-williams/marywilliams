...
const aboutMe2 = (
  <>
    {" "}
    Women in CS (WiCS),
    <br /> Society for Advancing Gender Equality (SAGES).
  </>
);
const aboutMe3 =
...
const aboutMe5 =
  "I like to spend my time reading, taking photos, finding new music, learning new things, exploring new hobbies, and getting outside";
const aboutMe6 =
    ...
    <div className="left-right-row">
      <div className="left-col">
        ...
        <div className="bottom-row">
          ...
          >
            <InfoBox size="grande" header="University Orgs">
              {aboutMe2}
            </InfoBox>
            <InfoBox size="grande" header="Hobbies">
              {aboutMe5}
            </InfoBox>
          </div>
        </div>
